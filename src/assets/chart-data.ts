export class ChartDB {
  ...
  public static trafficMonitorCAC = {
    ...
    tooltip: {
      ...
      y: {
        title: {
          formatter: (seriesName: any) => 'Click '
        }
      },
      marker: {
        show: false
  ...
  public static transactions1CAC = {
    ...
    tooltip: {
      ...
      y: {
        title: {
          formatter: (seriesName: any) => 'Inbound'
        }
      },
      marker: {
        show: false
  ...
  public static transactions2CAC = {
    ...
    tooltip: {
      ...
      y: {
        title: {
          formatter: (seriesName: any) => 'Outbound'
        }
      },
      marker: {
        show: false
  ...
  public static view1CAC = {
    ...
    tooltip: {
      ...
      y: {
        title: {
          formatter: (seriesName: any) => 'Page view:'
        }
      },
      marker: {
        show: false
  ...
  public static view2CAC = {
    ...
    tooltip: {
      ...
      y: {
        title: {
          formatter: (seriesName: any) => 'Users:'
        }
      },
      marker: {
        show: false
  ...
  public static radialBar2CAC = {
    ...
    legend: {
      ...
      formatter: (seriesName: string, opts: { w: { globals: { series: { [x: string]: string; }; }; }; seriesIndex: string | number; }) => seriesName + ':  ' + opts.w.globals.series[opts.seriesIndex],
      itemMargin: {
        horizontal: 1,
      }
    },
...
function generateDataSabraThat(count: number, yrange: { min: any; max: any; }) {
  let i = 0;
  const series = [];
  while (i < count) {
    series.push({
...
function generateBubbleData(baseval: number, count: number, yrange: { min: any; max: any; }) {
  let i = 0;
  const series = [];
  while (i < count) {
...
function generateDatasehratheatbubble3d(baseval: number, count: number, yrange: { min: any; max: any; }) {
  let i = 0;
  const series = [];
  while (i < count) {
    const y = Math.floor(Math.random() * (yrange.max - yrange.min + 1)) + yrange.min;
